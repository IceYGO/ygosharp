    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Api.Init(Config.GetString("RootPath", "."), Config.GetString("scriptDirectory ", "script"), Config.GetString("SecondaryScriptDirectory", "script"), Config.GetString("DatabaseFile", "cards.cdb"));
